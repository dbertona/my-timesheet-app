...
# Script para restaurar el workflow maestro en n8n usando la API v1
# API Key de n8n
...
echo "🚀 Restaurando workflow maestro en n8n usando API v1..."
echo "🔗 URL: $N8N_URL"
...
# Datos del workflow en formato JSON (simplificado para la API v1)
WORKFLOW_JSON='{
...
echo "📤 Enviando workflow a n8n usando API v1..."
