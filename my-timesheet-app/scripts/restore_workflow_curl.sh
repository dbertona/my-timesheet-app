...
# Script para restaurar el workflow maestro en n8n usando curl
# API Key de n8n
...
echo "🚀 Restaurando workflow maestro en n8n..."
echo "🔗 URL: $N8N_URL"
...
# Datos del workflow en formato JSON
WORKFLOW_JSON='{
...
# Crear el workflow usando curl
echo "📤 Enviando workflow a n8n..."
