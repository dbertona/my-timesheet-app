page 50709 "PS_Custome_Ledger_Entries"
{
    ApplicationArea = Basic, Suite;
    Caption = 'Maturity Control';
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(ReclamarPagos; Rec.ReclamarPagos)
                {
                ...
                field("Payment commitment date"; Rec."Payment commitment date")
                {
                    ApplicationArea = Basic, Suite;
                    StyleExpr = StyleTxt;
                    Editable = true;
                    ToolTip = 'Specifies the "Payment commitment date".';
                }
                ...
                field(RunningBalanceLCY; RunningBalanceLCY)
                {
                    ApplicationArea = Basic, Suite;
        ...
        area(processing)
        {
            group("Functions")
            {
                ...
                action(UnapplyEntries)
                {
                    ...
                    Image = UnApply;
                    Scope = Repeater;
                    ToolTip = 'Deselect one or more general ledger entries to which you want to cancel the application of this record.';
